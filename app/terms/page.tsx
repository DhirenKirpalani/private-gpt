...
const sections = {
  en: [
    ...
    { icon: Gift, title: "13. FREE TRIALS", body: `Exploro OS may offer free trials. Unless canceled before the trial period ends, subscriptions may automatically convert to paid plans. Users are responsible for reviewing applicable pricing before trial expiration.` },
  ...
  es: [
    ...
    { icon: Gift, title: "13. PRUEBAS GRATUITAS", body: `Exploro OS puede ofrecer pruebas gratuitas. A menos que se cancele antes de que finalice el período de prueba, las suscripciones pueden convertirse automáticamente en planes de pago.` },
