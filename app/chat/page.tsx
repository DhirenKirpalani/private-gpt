  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const systemPrompt = [
        ...
        `<!--ACTION:{"type":"send_email","to":"recipient@example.com","cc":"cc@example.com","subject":"Subject","body":"Email body text"}-->`,
        `If there is no CC recipient, omit the "cc" field. Use the MOST RECENT email address the user provided as the "to" field — do not swap recipients.`,
        ``,
